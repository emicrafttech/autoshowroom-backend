...
def _invoice_pdf(invoice: Invoice) -> BytesIO:
    ...
    pdf.setFont("Helvetica-Bold", 12)
    pdf.drawString(72, height - 300, f"Status: {invoice.get_status_display()}")
    pdf.drawRightString(width - 72, height - 300, f"Total: {_format_ngn(invoice.amount_ngn)}")

    pdf.setFont("Helvetica", 9)
    pdf.drawString(72, 72, "Generated by AutoShowroom.")
    pdf.showPage()
    pdf.save()
    buffer.seek(0)
    return buffer
