...
class BillingPlan(models.Model):
    ...
    videos_per_vehicle = models.PositiveSmallIntegerField(default=8)
    photos_per_vehicle = models.PositiveSmallIntegerField(default=30)
    max_clip_seconds = models.PositiveIntegerField(default=180)
